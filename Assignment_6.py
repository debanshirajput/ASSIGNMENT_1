...
student_data(student_id="21102114")
student_data(student_id="21102114",student_name="Debanshi Rajput")
student_data(student_id="21102114",student_name="Debanshi Rajput",student_class="1st Year")
print()
